...
export declare type assetCallback = (d: assetParam, timestamp?: number | true) => void;

export declare type assetEvent = {
    type: EventType.Asset;
    data: assetParam;
};

export declare type assetEventWithTime = assetEvent & {
    timestamp: number;
};

export declare type assetParam = {
    url: string;
...
export declare type eventWithoutTime = domContentLoadedEvent | loadedEvent | fullSnapshotEvent | incrementalSnapshotEvent | metaEvent | customEvent | pluginEvent | assetEvent;
...
export declare type NetworkBody = string | null;
...
export declare type NetworkEvent = pluginEvent<NetworkData>;

export declare type NetworkHeaders = Record<string, string>;

export declare type NetworkInitiatorType = 'audio' | 'beacon' | 'body' | 'css' | 'early-hint' | 'embed' | 'fetch' | 'frame' | 'iframe' | 'icon' | 'image' | 'img' | 'input' | 'link' | 'navigation' | 'object' | 'ping' | 'script' | 'track' | 'video' | 'xmlhttprequest';
...
export declare type NetworkRequest = Omit<PerformanceEntry, 'toJSON' | 'startTime' | 'endTime' | 'duration' | 'entryType'> & {
    method?: string;
...
export declare type SerializedBlobArg = {
    rr_type: 'Blob';
...
export declare type SerializedCssTextArg = {
    rr_type: 'CssText';
    cssTexts: string[];
};
