...
function mutationObserverCtor() {
  ...
  return [
    ...
    (_a = untaintedBaseIframeCleanup["MutationObserver"]) != null ? _a : () => {
    }
  ];
}
...
function rebuildIntoSandboxedIframe(n, options) {
  ...
  let node2;
  try {
    node2 = rebuild(n, __spreadProps(__spreadValues({}, options), {
      doc
    }));
  } catch (error) {
    (_a = iframe.parentNode) == null ? void 0 : _a.removeChild(iframe);
...
exports.rebuildIntoSandboxedIframe = rebuildIntoSandboxedIframe;
