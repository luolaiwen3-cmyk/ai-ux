...
export declare function createSandboxedIframe(options: CreateSandboxedIframeOptions): HTMLIFrameElement;

declare type CreateSandboxedIframeOptions = {
    root: Element;
...
export declare function rebuild(n: serializedNodeWithId, options: RebuildOptions): Node | null;

export declare function rebuildIntoSandboxedIframe(n: serializedNodeWithId, options: RebuildIntoSandboxedIframeOptions): {
    iframe: HTMLIFrameElement;
    node: Node | null;
};

declare type RebuildIntoSandboxedIframeOptions = CreateSandboxedIframeOptions & Omit<RebuildOptions, 'doc' | 'UNSAFE_allowUnprotectedRebuild'>;

declare type RebuildOptions = {
    doc: Document;
